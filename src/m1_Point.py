...
# ------------------------------------------------------------------------------
# TO: 2.          With your instructor, READ THE INSTRUCTIONS in
# TO (continued)  in file  m0_INSTRUCTIONS.txt, asking questions as needed.
#
# TO (continued): Then implement a class called   Point that has NO METHODS
# TO (continued)  yet, just the lines that start the definition of any class:
#
...
class Point(object):
    ...
    def move_to(self,x,y):
        self.dist=self.dist+self.get_distance_from(Point(x,y))
...
def run_test_repr():
    ...
    """
    # --------------------------------------------------------------------------
    # TO: 4.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_clone():
   ...
   """
    # --------------------------------------------------------------------------
    # TO: 5.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_move_to():
    ...
    """
    # --------------------------------------------------------------------------
    # TO: 6.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_get_number_of_moves_made():
    ...
    """
    # --------------------------------------------------------------------------
    # TO: 8.  Follow the same instructions as in _TODO_ 3 above,
    #    but for the  get_number_of_moves_made  method specified above.
    # TO (continued):  HINT: What must a Point REMEMBER for this method?
    # --------------------------------------------------------------------------
    print()
    print('-----------------------------------------------------------')
...
def run_test_get_distance_from():
    ...
    """
    # --------------------------------------------------------------------------
    # TO: 9.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_get_distance_from_start():
    ...
    """
    # --------------------------------------------------------------------------
    # TO: 10.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_get_distance_traveled():
    ...
    """
    # --------------------------------------------------------------------------
    # TO: 11.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_closer_to():
    ...
    """
    # --------------------------------------------------------------------------
    # TO: 12.  Follow the same instructions as in TO-DO 3 above,
